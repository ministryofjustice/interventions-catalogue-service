package uk.gov.justice.digital.hmpps.interventionscatalogue.util;
...
public class KeyGeneration {
    ...
    public KeyGeneration() throws ParseException, JOSEException, URISyntaxException, IOException {
        RSAKey rsaJWK = RSAKey.parse(Files.readString(Path.of("/jwt/rsaJWK.json")));

        System.out.println("Public JWK: " + rsaJWK.toPublicJWK().toJSONString());

        System.out.println("Signed token: " + getSignedToken(rsaJWK, Files.readString(Path.of("/jwt/token.json"))));
    }
